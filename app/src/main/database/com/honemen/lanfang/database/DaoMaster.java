...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        HttpRetryRequestDao.createTable(db, ifNotExists);
        HttpRetryPostParamDao.createTable(db, ifNotExists);
        HttpRetryGetParamDao.createTable(db, ifNotExists);
        AppCacheDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        HttpRetryRequestDao.dropTable(db, ifExists);
        HttpRetryPostParamDao.dropTable(db, ifExists);
        HttpRetryGetParamDao.dropTable(db, ifExists);
        AppCacheDao.dropTable(db, ifExists);
    }

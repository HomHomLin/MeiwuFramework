...
/**
 * Entity mapped to table HTTP_RETRY_POST_PARAM.
 */
public class HttpRetryPostParam {
    ...
    private transient HttpRetryPostParamDao myDao;
    ...
    public HttpRetryPostParam(Long id) {
        this.id = id;
    }

    public HttpRetryPostParam(Long id, String key, String value, boolean isFile, long requestId) {
        this.id = id;
        this.key = key;
        this.value = value;
        this.isFile = isFile;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getHttpRetryPostParamDao() : null;
    }
